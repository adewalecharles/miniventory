	...
	<div class="row">
		<div class="paymentCont">
						<div class="headingWrap">
								...
								<p class="text-center">You have to make #4000 one time payment to complete your registration, and start using our Inventory App</p>
						</div>
                        ...
                        <input type="hidden" name="key" value="{{ config('paystack.secretKey') }}"> {{-- required --}}
                          <input type="submit" name="options" checked> 
                        </form>
                        ...
                        <form method="POST" action="{{ route('pay') }}" accept-charset="UTF-8" role="form">
                          ...
                          <input type="hidden" name="reference" value="{{ Paystack::genTranxRef() }}"> {{-- required --}}
                          <input type="hidden" name="key" value="{{ config('paystack.secretKey') }}"> {{-- required --}}
                          <input type="submit" name="options"> 
                        </form>
					            </label>
					            <label class="btn paymentMethod">
