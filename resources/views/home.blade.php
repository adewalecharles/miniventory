        ...
        <table class="table stats-table ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @elseif ($product->qty < 5) <td><span class="label label-warning">Low</span></td>

                        @elseif ($product->qty <= 1) <td><span class="label label-danger">Out of Stock</span></td>
                            @endif
        ...
        <table class="table stats-table ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @elseif ($expiredproduct->qty < 5) <td><span class="label label-warning">Low</span></td>

                        @elseif ($expiredproduct->qty <= 1) <td><span class="label label-danger">Out of Stock</span>
                            </td>
                            @endif
        ...
        <table class="table stats-table ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="btn btn-info" href="{{ url('/checkout/invoice', $checkout->reference) }}">View</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
